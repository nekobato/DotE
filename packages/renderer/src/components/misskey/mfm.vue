...
// imported from: https://github.com/misskey-dev/misskey/blob/647a0183626042f29834c3b4dd8dbba88a799c4c/packages/frontend/src/components/mfm.ts
            ...
            case "mention": {
              return [
                h(MkMention, {
                  key: Math.random(),
                  host:
                    (token.props.host == null && this.author && this.author.host != null
                      ? this.author.host
